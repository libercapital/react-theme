...
const palette: Partial<Palette> = {
  ...
  divider: alpha('#506286', .5),
  background: {
    paper: '#FFFFFF',
    default: lighten(COLORS.primary.main, 0.3),
  },
  action: {
    active: alpha(COLORS.primary.main, ACTIVATED_OPACITY),
    activatedOpacity: ACTIVATED_OPACITY,
    hover: alpha(COLORS.grey['600'], HOVER_OPACITY),
    hoverOpacity: HOVER_OPACITY,
    selected: alpha(COLORS.grey['600'], SELECTED_OPACITY),
    selectedOpacity: SELECTED_OPACITY,
    disabled: '#9AAACB',
    disabledBackground: '#D5DCEB',
    disabledOpacity: DISABLED_OPACITY,
    focus: alpha(COLORS.grey['600'], FOCUS_OPACITY),
